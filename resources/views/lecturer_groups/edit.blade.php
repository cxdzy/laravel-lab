...
<head>
    ...
    <title>Edit Group | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Edit Lecturer Group</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Modify information for {{ $lecturer_group->name }} (ID: {{ $lecturer_group->id }})</p>
    </header>
    ...
    @if($errors->any())
        <div class="mb-8 p-5 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-800/30 rounded-2xl">
            <div class="flex mb-2">
                ...
                <h3 class="text-sm font-semibold text-red-800 dark:text-red-400">Please review the details:</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8">
        <form action="{{ route('lecturer-groups.update', $lecturer_group->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <!-- Group Name -->
                <div>
                    <label for="name" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Group Name
                    </label>
                    <input type="text" 
                           name="name" 
                ...
                <!-- Part -->
                <div>
                    <label for="part" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Part / Division
                    </label>
                    <input type="text" 
                           name="part" 
            ...
            <div class="pt-4">
                ...
                <a href="{{ route('lecturer-groups.index') }}" class="block text-center mt-4 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    Discard changes
                </a>
            </div>
        </form>
