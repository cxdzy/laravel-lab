            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name" class="form-control rounded-3 mm-input" required value="{{ old('name', $lecturer_group->name) }}" placeholder="e.g., Group A">
                    </div>
                    <div class="col-md-4">
                        <label for="part" class="form-label text-uppercase small text-body-secondary fw-semibold">Part / Division</label>
                        <input type="text" name="part" id="part" class="form-control rounded-3 mm-input" required value="{{ old('part', $lecturer_group->part) }}" placeholder="e.g., 1">
                    </div>
                </div>
            </div>
