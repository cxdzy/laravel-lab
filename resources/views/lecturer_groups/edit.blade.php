...
@section('page_title', 'Edit Lecturer Group')
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name" class="form-control rounded-3 mm-input @error('name') is-invalid @enderror" required value="{{ old('name', $lecturer_group->name) }}" placeholder="e.g., Group A">
                        @error('name')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="part" id="part" class="form-control rounded-3 mm-input @error('part') is-invalid @enderror" required value="{{ old('part', $lecturer_group->part) }}" placeholder="e.g., 1">
                        @error('part')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
