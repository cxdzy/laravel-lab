...
<head>
    ...
    <title>Create Group | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Create Lecturer Group</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Register a new academic group and department segment.</p>
    </header>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8">
        <form action="{{ route('lecturer-groups.store') }}" method="POST" class="space-y-8">
            @csrf
