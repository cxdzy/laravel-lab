...
<head>
    ...
    <title>Create Account | Minimalist Management</title>
    ...
    <div class="w-full max-w-xl py-12">
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-sm p-8 lg:p-12">
            <header class="text-center mb-10">
                <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white mb-2">Register Now.</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Create your account to get started.</p>
            </header>
            ...
            <form method="POST" action="/register" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Confirm</label>
                    ...
                    <!-- Address -->
                    <div>
                        <label for="address" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Address</label>
                        <input type="text" name="address" id="address" placeholder="123 Street, City"
                               class="input-focus w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-xl text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-600">
                    </div>
                </div>
            ...
            <footer class="mt-10 text-center">
                <p class="text-xs text-gray-400 dark:text-gray-600 uppercase tracking-widest font-medium">
                    Already have an account? <a href="/" class="text-black dark:text-white font-bold ml-1 hover:underline">Sign In</a>
                </p>
            </footer>
        </div>
