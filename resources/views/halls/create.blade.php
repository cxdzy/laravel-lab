...
<head>
    ...
    <title>Create Hall | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Create Hall</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Register a new lecture venue in the system.</p>
    </header>
    ...
    @if($errors->any())
        <div class="mb-8 p-5 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-800/30 rounded-2xl">
            <div class="flex mb-2">
                ...
                <h3 class="text-sm font-semibold text-red-800 dark:text-red-400">Review required fields:</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8">
        <form action="{{ route('halls.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="pt-4">
                ...
                <button type="reset" class="w-full mt-4 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    Reset entries
                </button>
            </div>
        </form>
