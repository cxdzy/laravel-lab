...
<head>
    ...
    <title>Halls | Minimalist Management</title>
    ...
    <script>
        ...
        // Initialize theme on page load - using a semicolon to prevent (intermediate value) errors
        (function() {
            try {
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <header class="flex justify-between items-end mb-10">
        <div>
            <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Halls</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage lecture halls and campus locations</p>
        </div>
        <div class="flex items-center space-x-4">
            ...
            <button onclick="toggleTheme()" class="p-2 rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors focus:outline-none">
                <svg class="w-5 h-5 hidden dark:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 9h-1m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 5a7 7 0 100 14 7 7 0 000-14z"></path>
                </svg>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50/50 dark:bg-gray-800/50 border-bottom border-gray-100 dark:border-gray-800">
                    ...
                    <th class="px-6 py-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Place</th>
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                ...
                <tr class="group hover:bg-gray-50/30 dark:hover:bg-gray-800/30 transition-colors">
                    <td class="px-6 py-4 text-sm text-gray-400 dark:text-gray-600 font-mono">
                        {{ str_pad($hall->id, 2, '0', STR_PAD_LEFT) }}
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ $hall->lecture_hall_name }}</span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-xs">
                        ...
                        <div class="inline-flex items-center space-x-1">
                            ...
                            <form action="{{ route('halls.destroy', $hall->id) }}" method="POST" class="inline">
                                ...
                                <button type="submit" 
                                        ...
                                        onclick="return confirm('Archive this hall?')">
