            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lecture_hall_name" id="lecture_hall_name" class="form-control rounded-3 mm-input @error('lecture_hall_name') is-invalid @enderror" required value="{{ old('lecture_hall_name', $hall->lecture_hall_name) }}" placeholder="e.g., Main Hall">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lecture_hall_place" id="lecture_hall_place" class="form-control rounded-3 mm-input @error('lecture_hall_place') is-invalid @enderror" required value="{{ old('lecture_hall_place', $hall->lecture_hall_place) }}" placeholder="e.g., Building A">
