            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="lecture_hall_name" id="lecture_hall_name" class="form-control rounded-3 mm-input" required value="{{ old('lecture_hall_name', $hall->lecture_hall_name) }}" placeholder="e.g., Main Hall">
                    </div>
                    <div class="col-md-6">
                        <label for="lecture_hall_place" class="form-label text-uppercase small text-body-secondary fw-semibold">Hall Place</label>
                        <input type="text" name="lecture_hall_place" id="lecture_hall_place" class="form-control rounded-3 mm-input" required value="{{ old('lecture_hall_place', $hall->lecture_hall_place) }}" placeholder="e.g., Building A">
                    </div>
                </div>
            </div>
