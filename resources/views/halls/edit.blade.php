...
<head>
    ...
    <title>Edit Hall | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Edit Hall</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update details for {{ $hall->lecture_hall_name }} (ID: {{ $hall->id }})</p>
    </header>
    ...
    @if($errors->any())
        <div class="mb-8 p-5 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-800/30 rounded-2xl">
            <div class="flex mb-2">
                ...
                <h3 class="text-sm font-semibold text-red-800 dark:text-red-400">Please correct the errors below:</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8">
        <form action="{{ route('halls.update', $hall->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <!-- Hall Name -->
                <div>
                    <label for="lecture_hall_name" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Hall Name
                    </label>
                    <input type="text" 
                ...
                <!-- Hall Place -->
                <div>
                    <label for="lecture_hall_place" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Hall Place / Location
                    </label>
                    <input type="text" 
                           ...
                           placeholder="e.g. North Campus, 2nd Floor"
                           class="input-focus w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-xl text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-600"
                           required>
                </div>
            </div>
            ...
            <div class="pt-4">
                ...
                <a href="{{ route('halls.index') }}" class="block text-center mt-4 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    Discard changes
                </a>
            </div>
        </form>
