...
<head>
    ...
    <title>Subjects | Minimalist Management</title>
...
<div class="max-w-6xl mx-auto px-4 py-12">
    ...
    <header class="flex justify-between items-end mb-10">
        <div>
            <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Subjects</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage academic courses and lecturer assignments</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <th class="px-6 py-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Code</th>
                        <th class="px-6 py-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Subject Name</th>
                        <th class="px-6 py-4 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Lecturer</th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                    ...
                    <tr class="group hover:bg-gray-50/30 dark:hover:bg-gray-800/30 transition-colors">
                        <td class="px-6 py-4 text-sm text-gray-400 dark:text-gray-600 font-mono">
                            {{ str_pad($subject->id, 2, '0', STR_PAD_LEFT) }}
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-xs font-bold tracking-tight bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 px-2 py-1 rounded">
                                {{ $subject->subject_code }}
                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ $subject->subject_name }}</span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="text-sm text-gray-500 dark:text-gray-400">{{ $subject->lecturer_name }}</span>
                        </td>
                            ...
                            <div class="inline-flex items-center space-x-1">
                                ...
                                <form action="{{ route('subjects.destroy', $subject->id) }}" method="POST" class="inline">
                                    ...
                                    <button type="submit" 
                                            ...
                                            onclick="return confirm('Archive this subject?')">
        ...
        <div class="px-6 py-20 text-center bg-white dark:bg-gray-900">
            ...
            <p class="text-gray-400 dark:text-gray-600 text-sm italic">No subjects registered yet.</p>
            <a href="{{ route('subjects.create') }}" class="mt-4 inline-block text-black dark:text-white text-sm font-medium underline">Register your first course</a>
        </div>
        @endif
    </div>
