...
<head>
    ...
    <title>Edit Subject | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Edit Subject</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update course details for {{ $subject->subject_name }} (ID: {{ $subject->id }})</p>
    </header>
    ...
    @if($errors->any())
        <div class="mb-8 p-5 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-800/30 rounded-2xl">
            <div class="flex mb-2">
                ...
                <h3 class="text-sm font-semibold text-red-800 dark:text-red-400">Please review the errors below:</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8 lg:p-10">
        <form action="{{ route('subjects.update', $subject->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <!-- Subject Code -->
                <div>
                    <label for="subject_code" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Subject Code
                    </label>
                    <input type="text" 
                           name="subject_code" 
                ...
                <!-- Subject Name -->
                <div>
                    <label for="subject_name" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Subject Name
                    </label>
                    <input type="text" 
                           name="subject_name" 
                ...
                <!-- Lecturer Name -->
                <div>
                    <label for="lecturer_name" class="block text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">
                        Lecturer Name
                    </label>
                    <input type="text" 
                           name="lecturer_name" 
                           id="lecturer_name"
                           value="{{ old('lecturer_name', $subject->lecturer_name) }}"
            ...
            <div class="pt-4">
                ...
                <div class="text-center mt-6">
                    <a href="{{ route('subjects.index') }}" class="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors uppercase tracking-widest font-semibold">
                        Discard changes
                    </a>
                </div>
            </div>
