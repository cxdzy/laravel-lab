            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="day_name" id="day_name" class="form-control rounded-3 mm-input @error('day_name') is-invalid @enderror" required autofocus value="{{ old('day_name') }}" placeholder="e.g., Monday">
                        @error('day_name')
