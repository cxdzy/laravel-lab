...
<head>
    ...
    <title>Create Day | Minimalist Management</title>
...
<div class="max-w-xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Create Day</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Define a new entry for your schedule.</p>
    </header>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8">
        <form action="{{ route('days.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       required>
                <p class="text-[11px] text-gray-400 mt-2 italic">Tip: Use standard day names for better organization.</p>
            </div>
