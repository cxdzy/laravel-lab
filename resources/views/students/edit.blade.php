...
<head>
    ...
    <title>Edit Student | Minimalist Management</title>
...
<div class="max-w-2xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Edit Student</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update profile details for {{ $student->name }} (ID: {{ $student->id }})</p>
    </header>
