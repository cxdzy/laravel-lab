            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="name" id="name" class="form-control rounded-3 mm-input @error('name') is-invalid @enderror" required autofocus value="{{ old('name') }}" placeholder="e.g., Jane Doe">
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" id="email" class="form-control rounded-3 mm-input @error('email') is-invalid @enderror" required value="{{ old('email') }}" placeholder="name@example.com">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone_number" id="phone_number" class="form-control rounded-3 mm-input @error('phone_number') is-invalid @enderror" value="{{ old('phone_number') }}" placeholder="Optional">
                        @error('phone_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="address" id="address" class="form-control rounded-3 mm-input @error('address') is-invalid @enderror" value="{{ old('address') }}" placeholder="Optional">
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control rounded-3 mm-input @error('password_confirmation') is-invalid @enderror" required>
