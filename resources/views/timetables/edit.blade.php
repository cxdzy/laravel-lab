...
<head>
    ...
    <title>Edit Timetable | Minimalist Management</title>
...
<div class="max-w-2xl mx-auto px-4 py-12">
    ...
    <header class="mb-10">
        ...
        <h1 class="text-3xl font-light tracking-tight text-gray-900 dark:text-white">Edit Timetable</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Modify the existing schedule entry (ID: {{ $timetable->id }}).</p>
    </header>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-8 lg:p-10">
        <form action="{{ route('timetables.update', $timetable->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
