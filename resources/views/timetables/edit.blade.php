            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <select name="user_id" id="user_id" class="form-select rounded-3 mm-input @error('user_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="subject_id" id="subject_id" class="form-select rounded-3 mm-input @error('subject_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="day_id" id="day_id" class="form-select rounded-3 mm-input @error('day_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="hall_id" id="hall_id" class="form-select rounded-3 mm-input @error('hall_id') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="lecturer_group_id" id="lecturer_group_id" class="form-select rounded-3 mm-input @error('lecturer_group_id') is-invalid @enderror">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_from" id="time_from" class="form-control rounded-3 mm-input @error('time_from') is-invalid @enderror" required value="{{ old('time_from', $timetable->time_from) }}">
                        @error('time_from')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_to" id="time_to" class="form-control rounded-3 mm-input @error('time_to') is-invalid @enderror" required value="{{ old('time_to', $timetable->time_to) }}">
                        @error('time_to')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
