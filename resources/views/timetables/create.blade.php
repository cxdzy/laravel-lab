...
@section('page_title', 'Create Timetable')
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_from" id="time_from" class="form-control rounded-3 mm-input @error('time_from') is-invalid @enderror" required value="{{ old('time_from') }}">
                        @error('time_from')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_to" id="time_to" class="form-control rounded-3 mm-input @error('time_to') is-invalid @enderror" required value="{{ old('time_to') }}">
                        @error('time_to')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
