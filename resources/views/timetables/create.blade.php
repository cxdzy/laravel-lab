            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="time_from" id="time_from" class="form-control rounded-3 mm-input" value="{{ old('time_from') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="time_to" class="form-label text-uppercase small text-body-secondary fw-semibold">End Time</label>
                        <input type="time" name="time_to" id="time_to" class="form-control rounded-3 mm-input" value="{{ old('time_to') }}">
                    </div>
                </div>
            </div>
